         ...
         if (!serverworld.func_217471_a(blockpos, 6)) {
            ...
            Vec3d vec3d = RandomPositionGenerator.func_221024_a(this.entity, 15, 7, (p_220734_3_) -> {
               if (!serverworld.func_217483_b_(p_220734_3_)) {
                  ...
                  Optional<BlockPos> optional1 = serverworld.getPointOfInterestManager().func_219127_a(PointOfInterestType.field_221053_a, this::func_220733_a, p_220734_3_, 10, PointOfInterestManager.Status.IS_OCCUPIED);
            ...
            if (vec3d == null) {
               ...
               Optional<BlockPos> optional = serverworld.getPointOfInterestManager().func_219127_a(PointOfInterestType.field_221053_a, this::func_220733_a, new BlockPos(vec3d), 10, PointOfInterestManager.Status.IS_OCCUPIED);
               if (!optional.isPresent()) {
                  ...
                  if (this.path == null) {
                     Vec3d vec3d1 = RandomPositionGenerator.findRandomTargetBlockTowards(this.entity, 10, 7, new Vec3d((double)this.field_220735_d.getX(), (double)this.field_220735_d.getY(), (double)this.field_220735_d.getZ()));
                     if (vec3d1 == null) {
                        return false;
                     }
