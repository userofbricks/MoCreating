...
public class AvoidEntityGoal<T extends LivingEntity> extends Goal {
   ...
   public boolean shouldExecute() {
      this.avoidTarget = this.entity.world.func_225318_b(this.classToAvoid, this.builtTargetSelector, this.entity, this.entity.posX, this.entity.posY, this.entity.posZ, this.entity.getBoundingBox().grow((double)this.avoidDistance, 3.0D, (double)this.avoidDistance));
