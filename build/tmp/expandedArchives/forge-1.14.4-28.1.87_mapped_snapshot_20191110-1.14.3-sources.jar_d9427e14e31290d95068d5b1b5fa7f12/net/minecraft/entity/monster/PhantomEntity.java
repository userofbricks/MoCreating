...
public class PhantomEntity extends FlyingEntity implements IMob {
   ...
   public void tick() {
      ...
      if (this.world.isRemote) {
         ...
         this.world.addParticle(ParticleTypes.MYCELIUM, this.posX + (double)f2, this.posY + (double)f4, this.posZ + (double)f3, 0.0D, 0.0D, 0.0D);
         this.world.addParticle(ParticleTypes.MYCELIUM, this.posX - (double)f2, this.posY + (double)f4, this.posZ - (double)f3, 0.0D, 0.0D, 0.0D);
      }
   ...
   abstract class MoveGoal extends Goal {
      ...
      protected boolean func_203146_f() {
         return PhantomEntity.this.orbitOffset.squareDistanceTo(PhantomEntity.this.posX, PhantomEntity.this.posY, PhantomEntity.this.posZ) < 4.0D;
      }
   }
   ...
   class MoveHelperController extends MovementController {
      ...
      public void tick() {
         ...
         float f = (float)(PhantomEntity.this.orbitOffset.x - PhantomEntity.this.posX);
         float f1 = (float)(PhantomEntity.this.orbitOffset.y - PhantomEntity.this.posY);
         float f2 = (float)(PhantomEntity.this.orbitOffset.z - PhantomEntity.this.posZ);
         ...
         Vec3d vec3d = PhantomEntity.this.getMotion();
         PhantomEntity.this.setMotion(vec3d.add((new Vec3d(d3, d5, d4)).subtract(vec3d).scale(0.2D)));
      }
   }
   ...
   class OrbitPointGoal extends PhantomEntity.MoveGoal {
      ...
      public void tick() {
         ...
         if (PhantomEntity.this.orbitOffset.y < PhantomEntity.this.posY && !PhantomEntity.this.world.isAirBlock((new BlockPos(PhantomEntity.this)).down(1))) {
            this.field_203152_e = Math.max(1.0F, this.field_203152_e);
            this.func_203148_i();
         }

         if (PhantomEntity.this.orbitOffset.y > PhantomEntity.this.posY && !PhantomEntity.this.world.isAirBlock((new BlockPos(PhantomEntity.this)).up(1))) {
   ...
   class SweepAttackGoal extends PhantomEntity.MoveGoal {
      ...
      public void tick() {
         LivingEntity livingentity = PhantomEntity.this.getAttackTarget();
         PhantomEntity.this.orbitOffset = new Vec3d(livingentity.posX, livingentity.posY + (double)livingentity.getHeight() * 0.5D, livingentity.posZ);
