...
public abstract class AbstractRaiderEntity extends PatrollerEntity {
         ...
         if (this.func_213658_ej()) {
            if (raid == null) {
               if (this.world.getGameTime() % 20L == 0L) {
                  ...
                  if (raid1 != null && RaidManager.func_215165_a(this, raid1)) {
                     raid1.func_221317_a(raid1.func_221315_l(), this, (BlockPos)null, true);
                  }
               }
            } else {
   ...
   public void readAdditional(CompoundNBT compound) {
      ...
      if (compound.contains("RaidId", 3)) {
         if (this.world instanceof ServerWorld) {
            this.raid = ((ServerWorld)this.world).getRaids().func_215167_a(compound.getInt("RaidId"));
         }
