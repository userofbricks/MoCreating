...
public class FoxEntity extends AnimalEntity {
   ...
   abstract class BaseGoal extends Goal {
      ...
      protected boolean func_220813_g() {
         ...
         return !FoxEntity.this.world.isSkyLightMax(blockpos) && FoxEntity.this.getBlockPathWeight(blockpos) >= 0.0F;
      }
      ...
      public boolean shouldExecute() {
         if (!FoxEntity.this.isSleeping() && this.creature.getAttackTarget() == null) {
            if (FoxEntity.this.world.isThundering()) {
               ...
               return FoxEntity.this.world.isDaytime() && FoxEntity.this.world.isSkyLightMax(blockpos) && !((ServerWorld)FoxEntity.this.world).func_217483_b_(blockpos) && this.func_220702_g();
            }
         } else {
            return false;
         }
