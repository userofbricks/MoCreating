...
public class VillagerEntity extends AbstractVillagerEntity implements IReputationTracking, IVillagerDataHolder {
   ...
   protected void updateAITasks() {
      ...
      if (this.previousCustomer != null && this.world instanceof ServerWorld) {
         ((ServerWorld)this.world).func_217489_a(IReputationType.TRADE, this.previousCustomer, this);
   ...
   private boolean func_223720_ew() {
      return this.field_223725_bO < 2 && this.world.getGameTime() > this.lastRestock + 2400L;
   }
   ...
   protected void func_213713_b(MerchantOffer p_213713_1_) {
      ...
      this.xp += p_213713_1_.getGivenExp();
   ...
   public ITextComponent getDisplayName() {
      ...
      if (itextcomponent != null) {
         ...
         VillagerProfession villagerprofession = this.getVillagerData().getProfession();
         ITextComponent itextcomponent1 = (new TranslationTextComponent(this.getType().getTranslationKey() + '.' + (!"minecraft".equals(villagerprofession.getRegistryName().getNamespace()) ? villagerprofession.getRegistryName().getNamespace() + '.' : "") + villagerprofession.getRegistryName().getPath())).applyTextStyle((p_213773_1_) -> {
   ...
   private void updateGolemLastSeenMemory(long p_223347_1_) {
