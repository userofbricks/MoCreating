...
public class MerchantContainer extends Container {
   ...
   public void func_217052_e(int p_217052_1_) {
      this.merchant.setXP(p_217052_1_);
   }
   ...
   private void playMerchantYesSound() {
      if (!this.merchant.getWorld().isRemote) {
         ...
         this.merchant.getWorld().playSound(entity.posX, entity.posY, entity.posZ, this.merchant.getYesSound(), SoundCategory.NEUTRAL, 1.0F, 1.0F, false);
      }
    ...
    */
   @OnlyIn(Dist.CLIENT)
   public void setClientSideOffers(MerchantOffers p_217044_1_) {
