...
public class BlockLootTables implements Consumer<BiConsumer<ResourceLocation, LootTable.Builder>> {
   ...
   private static LootTable.Builder func_218513_d(Block p_218513_0_) {
      return LootTable.builder().addLootPool(LootPool.builder().rolls(ConstantRange.of(1)).addEntry(func_218552_a(p_218513_0_, ItemLootEntry.builder(p_218513_0_).acceptFunction(SetCount.func_215932_a(ConstantRange.of(2)).acceptCondition(BlockStateProperty.builder(p_218513_0_).with(SlabBlock.TYPE, SlabType.DOUBLE))))));
   }
   ...
   private static <T extends Comparable<T>> LootTable.Builder func_218562_a(Block p_218562_0_, IProperty<T> p_218562_1_, T p_218562_2_) {
      return LootTable.builder().addLootPool(func_218560_a(p_218562_0_, LootPool.builder().rolls(ConstantRange.of(1)).addEntry(ItemLootEntry.builder(p_218562_0_).acceptCondition(BlockStateProperty.builder(p_218562_0_).with(p_218562_1_, p_218562_2_)))));
   }

   private static LootTable.Builder func_218481_e(Block p_218481_0_) {
      return LootTable.builder().addLootPool(func_218560_a(p_218481_0_, LootPool.builder().rolls(ConstantRange.of(1)).addEntry(ItemLootEntry.builder(p_218481_0_).acceptFunction(CopyName.builder(CopyName.Source.BLOCK_ENTITY)))));
   }

   private static LootTable.Builder func_218544_f(Block p_218544_0_) {
      return LootTable.builder().addLootPool(func_218560_a(p_218544_0_, LootPool.builder().rolls(ConstantRange.of(1)).addEntry(ItemLootEntry.builder(p_218544_0_).acceptFunction(CopyName.builder(CopyName.Source.BLOCK_ENTITY)).acceptFunction(CopyNbt.func_215881_a(CopyNbt.Source.BLOCK_ENTITY).func_216056_a("Lock", "BlockEntityTag.Lock").func_216056_a("LootTable", "BlockEntityTag.LootTable").func_216056_a("LootTableSeed", "BlockEntityTag.LootTableSeed")).acceptFunction(SetContents.func_215920_b().func_216075_a(DynamicLootEntry.func_216162_a(ShulkerBoxBlock.CONTENTS))))));
   }

   private static LootTable.Builder func_218559_g(Block p_218559_0_) {
      return LootTable.builder().addLootPool(func_218560_a(p_218559_0_, LootPool.builder().rolls(ConstantRange.of(1)).addEntry(ItemLootEntry.builder(p_218559_0_).acceptFunction(CopyName.builder(CopyName.Source.BLOCK_ENTITY)).acceptFunction(CopyNbt.func_215881_a(CopyNbt.Source.BLOCK_ENTITY).func_216056_a("Patterns", "BlockEntityTag.Patterns")))));
   }
   ...
   private static LootTable.Builder func_218491_c(Block p_218491_0_, IItemProvider p_218491_1_) {
      return func_218519_a(p_218491_0_, func_218552_a(p_218491_0_, ItemLootEntry.builder(p_218491_1_).acceptFunction(SetCount.func_215932_a(RandomValueRange.of(-6.0F, 2.0F))).acceptFunction(LimitCount.func_215911_a(IntClamper.func_215848_a(0)))));
   }
   ...
   private static LootTable.Builder func_218475_b(Block p_218475_0_, Item p_218475_1_) {
      return LootTable.builder().addLootPool(func_218552_a(p_218475_0_, LootPool.builder().rolls(ConstantRange.of(1)).addEntry(ItemLootEntry.builder(p_218475_1_).acceptFunction(SetCount.func_215932_a(BinomialRange.of(3, 0.06666667F)).acceptCondition(BlockStateProperty.builder(p_218475_0_).with(StemBlock.AGE, 0))).acceptFunction(SetCount.func_215932_a(BinomialRange.of(3, 0.13333334F)).acceptCondition(BlockStateProperty.builder(p_218475_0_).with(StemBlock.AGE, 1))).acceptFunction(SetCount.func_215932_a(BinomialRange.of(3, 0.2F)).acceptCondition(BlockStateProperty.builder(p_218475_0_).with(StemBlock.AGE, 2))).acceptFunction(SetCount.func_215932_a(BinomialRange.of(3, 0.26666668F)).acceptCondition(BlockStateProperty.builder(p_218475_0_).with(StemBlock.AGE, 3))).acceptFunction(SetCount.func_215932_a(BinomialRange.of(3, 0.33333334F)).acceptCondition(BlockStateProperty.builder(p_218475_0_).with(StemBlock.AGE, 4))).acceptFunction(SetCount.func_215932_a(BinomialRange.of(3, 0.4F)).acceptCondition(BlockStateProperty.builder(p_218475_0_).with(StemBlock.AGE, 5))).acceptFunction(SetCount.func_215932_a(BinomialRange.of(3, 0.46666667F)).acceptCondition(BlockStateProperty.builder(p_218475_0_).with(StemBlock.AGE, 6))).acceptFunction(SetCount.func_215932_a(BinomialRange.of(3, 0.53333336F)).acceptCondition(BlockStateProperty.builder(p_218475_0_).with(StemBlock.AGE, 7))))));
   }
   ...
   private static LootTable.Builder func_218540_a(Block p_218540_0_, Block p_218540_1_, float... p_218540_2_) {
      return func_218535_c(p_218540_0_, func_218560_a(p_218540_0_, ItemLootEntry.builder(p_218540_1_)).acceptCondition(TableBonus.builder(Enchantments.FORTUNE, p_218540_2_))).addLootPool(LootPool.builder().rolls(ConstantRange.of(1)).acceptCondition(field_218577_e).addEntry(func_218552_a(p_218540_0_, ItemLootEntry.builder(Items.STICK).acceptFunction(SetCount.func_215932_a(RandomValueRange.of(1.0F, 2.0F)))).acceptCondition(TableBonus.builder(Enchantments.FORTUNE, 0.02F, 0.022222223F, 0.025F, 0.033333335F, 0.1F))));
   }
   ...
   public void accept(BiConsumer<ResourceLocation, LootTable.Builder> p_accept_1_) {
      ...
      this.registerLootTable(Blocks.CHORUS_PLANT, func_218463_a(Items.CHORUS_FRUIT, RandomValueRange.of(0.0F, 1.0F)));
      ...
      this.registerLootTable(Blocks.COCOA, (p_218478_0_) -> {
         return LootTable.builder().addLootPool(LootPool.builder().rolls(ConstantRange.of(1)).addEntry(func_218552_a(p_218478_0_, ItemLootEntry.builder(Items.COCOA_BEANS).acceptFunction(SetCount.func_215932_a(ConstantRange.of(3)).acceptCondition(BlockStateProperty.builder(p_218478_0_).with(CocoaBlock.AGE, 2))))));
      });
      this.registerLootTable(Blocks.SEA_PICKLE, (p_218551_0_) -> {
         return LootTable.builder().addLootPool(LootPool.builder().rolls(ConstantRange.of(1)).addEntry(func_218552_a(p_218551_0_, ItemLootEntry.builder(p_218551_0_).acceptFunction(SetCount.func_215932_a(ConstantRange.of(2)).acceptCondition(BlockStateProperty.builder(p_218551_0_).with(SeaPickleBlock.PICKLES, 2))).acceptFunction(SetCount.func_215932_a(ConstantRange.of(3)).acceptCondition(BlockStateProperty.builder(p_218551_0_).with(SeaPickleBlock.PICKLES, 3))).acceptFunction(SetCount.func_215932_a(ConstantRange.of(4)).acceptCondition(BlockStateProperty.builder(p_218551_0_).with(SeaPickleBlock.PICKLES, 4))))));
      });
      this.registerLootTable(Blocks.COMPOSTER, (p_218565_0_) -> {
         return LootTable.builder().addLootPool(LootPool.builder().addEntry(func_218552_a(p_218565_0_, ItemLootEntry.builder(Items.COMPOSTER)))).addLootPool(LootPool.builder().addEntry(ItemLootEntry.builder(Items.BONE_MEAL)).acceptCondition(BlockStateProperty.builder(p_218565_0_).with(ComposterBlock.LEVEL, 8)));
      });
      ...
      this.registerLootTable(Blocks.PLAYER_HEAD, (p_218473_0_) -> {
         return LootTable.builder().addLootPool(func_218560_a(p_218473_0_, LootPool.builder().rolls(ConstantRange.of(1)).addEntry(ItemLootEntry.builder(p_218473_0_).acceptFunction(CopyNbt.func_215881_a(CopyNbt.Source.BLOCK_ENTITY).func_216056_a("Owner", "SkullOwner")))));
      });
      ...
      this.registerLootTable(Blocks.CARROTS, (p_218542_1_) -> {
         return func_218552_a(p_218542_1_, LootTable.builder().addLootPool(LootPool.builder().addEntry(ItemLootEntry.builder(Items.CARROT))).addLootPool(LootPool.builder().acceptCondition(ilootcondition$ibuilder2).addEntry(ItemLootEntry.builder(Items.CARROT).acceptFunction(ApplyBonus.func_215870_a(Enchantments.FORTUNE, 0.5714286F, 3)))));
      });
      ...
      this.registerLootTable(Blocks.POTATOES, (p_218563_1_) -> {
         return func_218552_a(p_218563_1_, LootTable.builder().addLootPool(LootPool.builder().addEntry(ItemLootEntry.builder(Items.POTATO))).addLootPool(LootPool.builder().acceptCondition(ilootcondition$ibuilder3).addEntry(ItemLootEntry.builder(Items.POTATO).acceptFunction(ApplyBonus.func_215870_a(Enchantments.FORTUNE, 0.5714286F, 3)))).addLootPool(LootPool.builder().acceptCondition(ilootcondition$ibuilder3).addEntry(ItemLootEntry.builder(Items.POISONOUS_POTATO).acceptCondition(RandomChance.builder(0.02F)))));
      });
      this.registerLootTable(Blocks.SWEET_BERRY_BUSH, (p_218554_0_) -> {
         return func_218552_a(p_218554_0_, LootTable.builder().addLootPool(LootPool.builder().acceptCondition(BlockStateProperty.builder(Blocks.SWEET_BERRY_BUSH).with(SweetBerryBushBlock.AGE, 3)).addEntry(ItemLootEntry.builder(Items.SWEET_BERRIES)).acceptFunction(SetCount.func_215932_a(RandomValueRange.of(2.0F, 3.0F))).acceptFunction(ApplyBonus.func_215871_b(Enchantments.FORTUNE))).addLootPool(LootPool.builder().acceptCondition(BlockStateProperty.builder(Blocks.SWEET_BERRY_BUSH).with(SweetBerryBushBlock.AGE, 2)).addEntry(ItemLootEntry.builder(Items.SWEET_BERRIES)).acceptFunction(SetCount.func_215932_a(RandomValueRange.of(1.0F, 2.0F))).acceptFunction(ApplyBonus.func_215871_b(Enchantments.FORTUNE))));
      });
      ...
      this.registerLootTable(Blocks.LAPIS_ORE, (p_218531_0_) -> {
         return func_218519_a(p_218531_0_, func_218552_a(p_218531_0_, ItemLootEntry.builder(Items.LAPIS_LAZULI).acceptFunction(SetCount.func_215932_a(RandomValueRange.of(4.0F, 9.0F))).acceptFunction(ApplyBonus.func_215869_a(Enchantments.FORTUNE))));
      });
      this.registerLootTable(Blocks.COBWEB, (p_218467_0_) -> {
         return func_218535_c(p_218467_0_, func_218560_a(p_218467_0_, ItemLootEntry.builder(Items.STRING)));
      });
      this.registerLootTable(Blocks.DEAD_BUSH, (p_218509_0_) -> {
         return func_218511_b(p_218509_0_, func_218552_a(p_218509_0_, ItemLootEntry.builder(Items.STICK).acceptFunction(SetCount.func_215932_a(RandomValueRange.of(0.0F, 2.0F)))));
      });
      ...
      this.registerLootTable(Blocks.LARGE_FERN, func_218486_d(Blocks.FERN));
      this.registerLootTable(Blocks.TALL_GRASS, (p_218512_0_) -> {
         return func_218511_b(Blocks.GRASS, ((StandaloneLootEntry.Builder)func_218560_a(p_218512_0_, ItemLootEntry.builder(Items.WHEAT_SEEDS)).acceptCondition(BlockStateProperty.builder(p_218512_0_).with(DoublePlantBlock.HALF, DoubleBlockHalf.LOWER))).acceptCondition(RandomChance.builder(0.125F)));
      });
      ...
      this.registerLootTable(Blocks.CHORUS_FLOWER, (p_218464_0_) -> {
         return LootTable.builder().addLootPool(LootPool.builder().rolls(ConstantRange.of(1)).addEntry(func_218560_a(p_218464_0_, ItemLootEntry.builder(p_218464_0_)).acceptCondition(EntityHasProperty.builder(LootContext.EntityTarget.THIS))));
      });
   ...
   public void func_218547_a(Block p_218547_1_) {
      this.registerLootTable(p_218547_1_, (p_218524_0_) -> {
   ...
   private void registerLootTable(Block p_218522_1_, Function<Block, LootTable.Builder> p_218522_2_) {
      this.registerLootTable(p_218522_1_, p_218522_2_.apply(p_218522_1_));
   }

   private void registerLootTable(Block p_218507_1_, LootTable.Builder p_218507_2_) {
