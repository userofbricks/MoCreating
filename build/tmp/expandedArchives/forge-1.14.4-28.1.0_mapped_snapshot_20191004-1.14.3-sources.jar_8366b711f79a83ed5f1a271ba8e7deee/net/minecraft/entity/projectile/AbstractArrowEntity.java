...
public abstract class AbstractArrowEntity extends Entity implements IProjectile {
   ...
   private SoundEvent hitSound = this.func_213867_k();
   ...
   public void readAdditional(CompoundNBT compound) {
      ...
      if (compound.contains("SoundEvent", 8)) {
         this.hitSound = Registry.SOUND_EVENT.getValue(new ResourceLocation(compound.getString("SoundEvent"))).orElse(this.func_213867_k());
      }
