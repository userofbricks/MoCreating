...
public class GameRenderer implements AutoCloseable, IResourceManagerReloadListener {
   ...
   private void setupCameraTransform(float partialTicks) {
      ...
      GlStateManager.multMatrix(Matrix4f.perspective(this.getFOVModifier(this.activeRender, partialTicks, true), (float)this.mc.mainWindow.getFramebufferWidth() / (float)this.mc.mainWindow.getFramebufferHeight(), 0.05F, this.farPlaneDistance * MathHelper.SQRT_2));
   ...
   private void renderHand(ActiveRenderInfo p_215308_1_, float p_215308_2_) {
      if (!this.debugView) {
         GlStateManager.matrixMode(5889);
         GlStateManager.loadIdentity();
         GlStateManager.multMatrix(Matrix4f.perspective(this.getFOVModifier(p_215308_1_, p_215308_2_, false), (float)this.mc.mainWindow.getFramebufferWidth() / (float)this.mc.mainWindow.getFramebufferHeight(), 0.05F, this.farPlaneDistance * 2.0F));
         GlStateManager.matrixMode(5888);
         GlStateManager.loadIdentity();
   ...
   private void updateCameraAndRender(float partialTicks, long nanoTime) {
      ...
      if (this.mc.gameSettings.renderDistanceChunks >= 4) {
         ...
         GlStateManager.matrixMode(5889);
         GlStateManager.loadIdentity();
         GlStateManager.multMatrix(Matrix4f.perspective(this.getFOVModifier(activerenderinfo, partialTicks, true), (float)this.mc.mainWindow.getFramebufferWidth() / (float)this.mc.mainWindow.getFramebufferHeight(), 0.05F, this.farPlaneDistance * 2.0F));
         GlStateManager.matrixMode(5888);
         worldrenderer.renderSky(partialTicks);
         GlStateManager.matrixMode(5889);
         GlStateManager.loadIdentity();
         GlStateManager.multMatrix(Matrix4f.perspective(this.getFOVModifier(activerenderinfo, partialTicks, true), (float)this.mc.mainWindow.getFramebufferWidth() / (float)this.mc.mainWindow.getFramebufferHeight(), 0.05F, this.farPlaneDistance * MathHelper.SQRT_2));
         GlStateManager.matrixMode(5888);
      }
   ...
   private void renderClouds(ActiveRenderInfo p_215313_1_, WorldRenderer p_215313_2_, float p_215313_3_, double p_215313_4_, double p_215313_6_, double p_215313_8_) {
      if (this.mc.gameSettings.getCloudOption() != CloudOption.OFF) {
         ...
         GlStateManager.matrixMode(5889);
         GlStateManager.loadIdentity();
         GlStateManager.multMatrix(Matrix4f.perspective(this.getFOVModifier(p_215313_1_, p_215313_3_, true), (float)this.mc.mainWindow.getFramebufferWidth() / (float)this.mc.mainWindow.getFramebufferHeight(), 0.05F, this.farPlaneDistance * 4.0F));
         GlStateManager.matrixMode(5888);
         GlStateManager.pushMatrix();
         ...
         GlStateManager.matrixMode(5889);
         GlStateManager.loadIdentity();
         GlStateManager.multMatrix(Matrix4f.perspective(this.getFOVModifier(p_215313_1_, p_215313_3_, true), (float)this.mc.mainWindow.getFramebufferWidth() / (float)this.mc.mainWindow.getFramebufferHeight(), 0.05F, this.farPlaneDistance * MathHelper.SQRT_2));
         GlStateManager.matrixMode(5888);
      }
