...
public class FluidBlockRenderer {
   ...
   public boolean render(IEnviromentBlockReader reader, BlockPos pos, BufferBuilder bufferBuilderIn, IFluidState fluidStateIn) {
      ...
      if (atextureatlassprite == null) atextureatlassprite = flag ? this.atlasSpritesLava : this.atlasSpritesWater;
      int i = fluidStateIn.getFluid().getAttributes().getColor(reader, pos);
      if (i < 0) i = flag ? 16777215 : BiomeColors.getWaterColor(reader, pos);
