...
public class ServerPlayerEntity extends PlayerEntity implements IContainerListener {
      ...
      if (p_205734_1_.dimension.hasSkyLight() && p_205734_1_.getWorldInfo().getGameType() != GameType.ADVENTURE) {
         ...
         for(int l1 = 0; l1 < i1; ++l1) {
            ...
            if (blockpos1 != null) {
               ...
               if (p_205734_1_.areCollisionShapesEmpty(this)) {
                  break;
               }
            }
         }
         ...
         while(!p_205734_1_.areCollisionShapesEmpty(this) && this.posY < 255.0D) {
   ...
   public Entity changeDimension(DimensionType destination) {
      ...
      if (dimensiontype == DimensionType.THE_END && destination == DimensionType.OVERWORLD) {
         ...
         this.connection.sendPacket(new SRespawnPacket(destination, worldinfo.getGenerator(), this.interactionManager.getGameType()));
         ...
         this.connection.setPlayerLocation(this.posX, this.posY, this.posZ, f1, f);
   ...
   public void copyFrom(ServerPlayerEntity that, boolean keepEverything) {
      ...
      CompoundNBT old = that.getPersistantData();
      if (old.contains(PERSISTED_NBT_TAG))
          getPersistantData().put(PERSISTED_NBT_TAG, old.get(PERSISTED_NBT_TAG));
   ...
   public void teleport(ServerWorld p_200619_1_, double x, double y, double z, float yaw, float pitch) {
      ...
      if (p_200619_1_ == this.world) {
         ...
         this.connection.sendPacket(new SRespawnPacket(this.dimension, worldinfo.getGenerator(), this.interactionManager.getGameType()));
         this.connection.sendPacket(new SServerDifficultyPacket(worldinfo.getDifficulty(), worldinfo.isDifficultyLocked()));
   ...
   public void func_213823_a(SoundEvent p_213823_1_, SoundCategory p_213823_2_, float p_213823_3_, float p_213823_4_) {
      this.connection.sendPacket(new SPlaySoundEffectPacket(p_213823_1_, p_213823_2_, this.posX, this.posY, this.posZ, p_213823_3_, p_213823_4_));
   }
