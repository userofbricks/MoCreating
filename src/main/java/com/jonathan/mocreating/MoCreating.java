	...
	public static class RegistryEvents
	{
		...
		public static void registerBlocks(final RegistryEvent.Register<Block> event)
		{
			...
			(
				...
				BlockList.mycelium_netherrack 		= new NetherMycelium(						Block.Properties.create(Material.ROCK)		.hardnessAndResistance(2.0f, 15.0f)	.sound(SoundType.STONE)			.harvestTool(ToolType.PICKAXE))	.setRegistryName(location("mycelium_netherrack")),
